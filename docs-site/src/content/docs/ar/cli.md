...
ولتشغيل أجهزة iOS الفعلية، يجب ضبط المتغير `ASTUR_IOS_DEVELOPMENT_TEAM` ليسمح لـ Xcode بتوقيع الوكيل `XCUITest`، مع التأكد من أن سلسلة المفاتيح (Keychain) في الـ macOS مفتوحة ومتاحة للاستخدام. 
